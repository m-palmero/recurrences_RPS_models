...
-   **`data/mobility/`**: **Input Directory.** This folder must contain the time series data generated by the RPS simulation. Each file should be named according to the convention `<mobility>-<initial_condition_id>.dat`. For example, `0.30-2.dat` corresponds to the 2nd simulation run with a mobility parameter of 0.3.
